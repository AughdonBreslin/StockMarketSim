...
async function test() {
    ...
    try {
        const result = await transactions.buy("6278298ba1eb25c069188944", "AMZN", 1, false, 2000, 1, true)
    } catch(e) {
        console.log(e)
    }
    try {
    ...
    try {
        const result = await transactions.sell("6278298ba1eb25c069188944", "GOOG", 1, false, 1000, true)
    } catch(e) {
        console.log(e)
    }
    try {
        await transactions.autoTrade()
    } catch(e) {
        console.log(e)
    }
}
